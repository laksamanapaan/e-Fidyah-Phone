...
<td width="88"><a href="cFeb.php" class="sprev" rel="external"> <span class="prev">Februari </span></a></td>
<td width="275"><h4 align="center"> Mac </h4><h4 align="center">Jamadil Awwal / Jamadil Akhir</h4></td>
<td width="84"><a href="cApr.php" class="next" rel="external"> April </a></td>
</table>
<p></p>
<table width="461" border="0" align="center">
  ...
  <tr bgcolor="#CCCCCC">
    ...
    <td align="center"><input type="button" class="button2"  onclick="alertFunction(3,23)" value="3&#x00A;23" align="center"/></td>
    <td align="center"><input type="button" class="button2"  onclick="alertFunction(4,24)" value="4&#x00A;24" align="center"/></td>
    <td align="center"><input type="button" class="button2"  onclick="alertFunction(5,25)" value="5&#x00A;25" align="center"/></td>
  </tr>
  <tr>
